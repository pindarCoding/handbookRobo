    ...
    <div className="h-full flex flex-col">
      ...
      {context === "desktop" && (
        <ProgressIndicator currentStep={currentStep} variant="compact"
          hasThemeSelected={!!selectedTheme}
          hasSubThemeSelected={!!selectedSubTheme}
          hasGenerationSelected={!!selectedGeneration}
        />
      )}
          ...
          {currentStep === "generation" && (
            ...
            `}
                  ...
                  ${selectedGeneration?.id === generation.id
                        ...
                        <p
                          className={`text-slate-500 dark:text-slate-400 ${context === "mobile" ? "text-xs" : "text-xs"
                            }`}
                        >
                          {generation.ageRange}
                        </p>
